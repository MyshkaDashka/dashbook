...
<div id="wrapper1">
    ...
    <div class="content">
        <div class="column-left">
            ...
            <ul class="menu">
                <li><a href="/profile.jsp" class="active">Home</a></li>
        ...
        <div class="column-right">
            <div class="box">
                ...
                <div class="box-in">
                    <form:form action="/message" method="POST" commandName="messagesForm" class="register-form">
                        <div class="header">
                            <h1>Send message.</h1>
                            <span></span>
                        </div>
                        <div class="content">
                            <h2>To:</h2><input type="text" class="input" placeholder="Name" name="to" required> <br/>
